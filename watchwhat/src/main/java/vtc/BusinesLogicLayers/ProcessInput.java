...
import vtc.PresentationLayers.ConsoleUserInterface.LoginCUI;
import vtc.PresentationLayers.ConsoleUserInterface.ProfileCUI;
import vtc.PresentationLayers.ConsoleUserInterface.RegisterCUI;
import vtc.Utils.Constants;
import vtc.Utils.TempData;
import vtc.Utils.MaskingPassword.PasswordField;
...
public class ProcessInput {
    ...
    public String checkEmail(int x) {
        ...
        while (checkemail) {
            ...
            // checkemail = UserBL.Email_Exist(emailString);
            checkemail = false;
        }
        return emailString;
    }
