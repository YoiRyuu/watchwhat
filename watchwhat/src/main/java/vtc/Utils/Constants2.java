...
public class Constants2 {
    ...
    public static int movieinfo_id;
    public static String movieinfo_name;
    public static String movieinfo_director;
    public static int movieinfo_year;
    public static Date movieinfo_Date;
    public static String movieinfo_cover;
    public static String movieinfo_certificate;
    public static double movieinfo_rate;
    public static String movieinfo_description;
    public static String movieinfo_nation;
    public static String movieinfo_tag;
    // Decorate
    ...
    public static String buttonsearchmovnation  = "| [2] Search movie by nations                |";
    public static String buttonsearchmovtag     = "| [3] Search movie by tags                   |";
